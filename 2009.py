...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/Aftabbaloch786/Approve.txt/blob/main/Approve.txt"])
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/Aftabbaloch786/Approve.txt/blob/main/Approve.txt').text
			if basesplit in plr:
				key = basesplit
